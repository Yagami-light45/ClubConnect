      ...
      default:
        return (
          <div className="text-center p-8">
            ...
            <p className="text-gray-500 mt-2">Role: {currentUser.role} is not recognized.</p>
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">{renderDashboard()}</main>
        {showNotifications && (
